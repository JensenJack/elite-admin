<!-- PAGE OR LINK field -->
<!-- Used in LuisMareze\MenuCRUD -->

<?php
    $field['options'] = ['page_link' => trans('luismareze::crud.page_link'), 'internal_link' => trans('luismareze::crud.internal_link'), 'external_link' => trans('luismareze::crud.external_link')];
        ...
        <!-- external link input -->
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'external_link') { echo 'hidden'; } ?>" id="page_or_link_external_link">
            <input
                ...
                class="form-control"
                name="link"
                placeholder="{{ trans('luismareze::crud.page_link_placeholder') }}"
          ...
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'internal_link') { echo 'hidden'; } ?>" id="page_or_link_internal_link">
            <input
                ...
                class="form-control"
                name="link"
                placeholder="{{ trans('luismareze::crud.internal_link_placeholder', ['url', url('admin/page')]) }}"
